...
const projects = [
  ...
  },
  {
    ...
    title: 'Botrytis gray mold of Lilium: Diagnosis, basic study and control',
    description: 'Co-author. Pathogen identification, disease characterisation, and control strategies for Botrytis cinerea on Lilium in Bangladesh. Published in Heliyon 10(12), e33165 (2024).',
    tags: ['Lilium', 'Botrytis', 'Disease', 'Heliyon'],
    year: '2024',
    status: 'Published',
    icon: '🌷',
  },
  {
    ...
    description: 'Morpho-physiological characterisation of Lilium germplasm. Published in Bangladesh Journal of Agricultural Research 47(1), 39–50 (2022). DOI: 10.3329/bjar.v47i1.64853',
    tags: ['Lilium', 'Germplasm', 'Characterization', 'BJAR'],
    year: '2022',
    status: 'Published',
    icon: '🌼',
  },
  {
    category: 'Floriculture',
    title: 'Bulb preservation for offseason Lilium flower and bulb production',
    description: 'Effects of temperature and media on bulb preservation and offseason flowering in Lilium. Published in Current Horticulture 12(1), 35–42 (2024).',
    tags: ['Lilium', 'Bulb', 'Preservation', 'Offseason'],
    year: '2024',
    status: 'Published',
    icon: '🌸',
  },
